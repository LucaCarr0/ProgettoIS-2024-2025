...
// Classe che si occupa dell'invio effettivo delle email
public class EmailService {
	...
	public void sendEmail(EmailMessage message) throws MessagingException {
		...
		// Per farlo viene fornito un Authenticator personalizzato che ridefinisce il
		// metodo getPasswordAuthentication().
		// Questo metodo viene chiamato automaticamente quando il server SMTP richiederà
		// le credenziali. Se non lo avessi ridefinito la Session non saprebbe con che
		// credenziali autenticarsi,
		// e l'invio della mail fallirebbe (il metodo standard non ridefinito ritorna
		// null sempre).
